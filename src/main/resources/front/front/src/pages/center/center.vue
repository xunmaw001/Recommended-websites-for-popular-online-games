    ...
    <el-tabs tab-position="left" :style='{"alignItems":"center","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","justifyContent":"center"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="120px">
          ...
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='yonghu'" label="照片">
            <el-upload
              ...
              <img :style='{"border":"1px solid #bfecb9","cursor":"pointer","color":"#666","borderRadius":"6px","textAlign":"center","background":"#eff8ee","width":"100px","fontSize":"32px","lineHeight":"100px","height":"100px"}' v-if="sessionForm.zhaopian" :src="baseUrl + sessionForm.zhaopian" class="avatar">
          ...
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='yonghu'" label="身份证号" prop="shenfenzhenghao">
