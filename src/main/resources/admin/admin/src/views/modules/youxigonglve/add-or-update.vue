	...
	<div class="addEdit-block" :style='{"padding":"0px 0px","margin":"0px auto 0 auto","borderColor":"#eee","overflow":"hidden","background":"#f6f6f6","borderWidth":"1px 0 0","width":"94%","position":"relative","borderStyle":"solid"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="攻略关卡" prop="gonglveguanka">
					<el-input v-model="ruleForm.gonglveguanka" placeholder="攻略关卡" clearable  :readonly="ro.gonglveguanka"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' v-else class="input" label="攻略关卡" prop="gonglveguanka">
					<el-input v-model="ruleForm.gonglveguanka" placeholder="攻略关卡" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' class="upload" v-if="type!='info'&& !ro.gonglveshipin" label="攻略视频" prop="gonglveshipin">
					<file-upload
						tip="点击上传攻略视频"
						action="file/upload"
						:limit="1"
						:multiple="true"
						:fileUrls="ruleForm.gonglveshipin?ruleForm.gonglveshipin:''"
						@change="gonglveshipinUploadChange"
					></file-upload>
				</el-form-item> 
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' v-else-if="ruleForm.gonglveshipin" label="攻略视频" prop="gonglveshipin">
					<el-button :style='{"border":"0px dotted #79b91a","cursor":"pointer","padding":"0 24px","margin":"0 20px 0 0","outline":"none","color":"#fff","borderRadius":"0px","background":"#18cfa5","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.gonglveshipin)">预览</el-button>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' v-else-if="!ruleForm.gonglveshipin" label="攻略视频" prop="gonglveshipin">
				...
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' v-if="type!='info'"  label="游戏攻略" prop="youxigonglve">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' v-else-if="ruleForm.youxigonglve" label="游戏攻略" prop="youxigonglve">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.youxigonglve"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='gonglveguanka'){
							this.ruleForm.gonglveguanka = obj[o];
							this.ro.gonglveguanka = true;
							continue;
						}
						if(o=='gonglveshipin'){
							this.ruleForm.gonglveshipin = obj[o];
							this.ro.gonglveshipin = true;
							continue;
						}
						if(o=='youxifengmian'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.youxigonglve = this.ruleForm.youxigonglve.replace(reg,'../../../springboots5832/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.gonglveshipin!=null) {
		this.ruleForm.gonglveshipin = this.ruleForm.gonglveshipin.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    gonglveshipinUploadChange(fileUrls) {
	    this.ruleForm.gonglveshipin = fileUrls;
    },
